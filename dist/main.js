...
function $2d6bb60f15a5fadc$export$604ba5624273df44() {
...
$5baf55e49bc96444$exports = JSON.parse('{"pt":{"Conhe\xe7a o NDD Orbix":{"headline":"Conhe\xe7a o NDD Orbix","description":"Explores m\xf3dulos e recursos e saiba como podemos ajudar na sustentabilidade do seu neg\xf3cio."},"Manuais":{"headline":"Manuais","description":"Guia completo de instala\xe7\xe3o e integra\xe7\xe3o com o NDD Orbix: pr\xe9-requisitos e manuais."},"O que h\xe1 de novo?":{"headline":"O que h\xe1 de novo?","description":"Hist\xf3rico de vers\xf5es, novas funcionalidades e corre\xe7\xf5es."},"FAQ":{"headline":"FAQ"}},"en":{"Conhe\xe7a o NDD Orbix":{"headline":"Discover NDD Orbix","description":"Explore modules and features and see how we can help with the sustainability of your business."},"Manuais":{"headline":"Manuals","description":"Complete guide to installation and integration with NDD Orbix: prerequisites and manuals."},"O que h\xe1 de novo?":{"headline":"What\'s new?","description":"Version history, new features and fixes."},"FAQ":{"headline":"FAQ - EN"}}}');


function $ed17317835264a01$export$ac45879b58ed4b07(lang) {
    const tiles = document.querySelectorAll('[data-vp-id="portal-space-tile"]');
    tiles.forEach((tile)=>{
        const tileName = tile.getAttribute("data-vp-name");
        const { headline: headline, description: description } = (0, (/*@__PURE__*/$parcel$interopDefault($5baf55e49bc96444$exports)))[lang][tileName] || {};
...
$56669774ddba6fe6$exports = JSON.parse('{"pt":{"Informa\xe7\xf5es complementares":{"text":"Informa\xe7\xf5es complementares"},"Preciso de ajuda":{"text":"Preciso de ajuda"},"Seguran\xe7a e compliance":{"text":"Seguran\xe7a e compliance"}},"en":{"Informa\xe7\xf5es complementares":{"text":"Further information"},"Preciso de ajuda":{"text":"I need some help"},"Seguran\xe7a e compliance":{"text":"Security & compliance"}}}');


function $5c24a9cd18c1eb33$export$1d968f626f4867a0(lang) {
    const categories = document.querySelectorAll(".portal__content__heading h2");
    categories.forEach((category)=>{
        const categoryName = category.textContent;
        const categoryText = (0, (/*@__PURE__*/$parcel$interopDefault($56669774ddba6fe6$exports)))[lang]?.[categoryName]?.text;
        if (!categoryText) {
...
$e373bb45b263ea70$exports = JSON.parse('{"pt":{"Acesse o NDD Orbix":{"text":"Acesse o NDD Orbix"},"Vendas":{"text":"Vendas"}},"en":{"Acesse o NDD Orbix":{"text":"Try NDD Orbix"},"Vendas":{"text":"Sales"}},"es":{"Acesse o NDD Orbix":{"text":"Acceda a NDD Orbix"},"Vendas":{"text":"Ventas"}}}');


function $0bef1161658a365b$export$1edb4355a6269a50(lang) {
    ...
    links.forEach((link)=>{
        ...
        const linkText = (0, (/*@__PURE__*/$parcel$interopDefault($e373bb45b263ea70$exports)))[lang]?.[linkSanitized]?.text;
        if (!linkText) {
...
const $95930220612465e5$var$languagePicked = (0, $2d6bb60f15a5fadc$export$604ba5624273df44)();
(0, $0338f0fd1d201d30$export$ee302119ce9aa13b)(()=>(0, $ed17317835264a01$export$ac45879b58ed4b07)($95930220612465e5$var$languagePicked), "/");
(0, $0338f0fd1d201d30$export$ee302119ce9aa13b)(()=>(0, $5c24a9cd18c1eb33$export$1d968f626f4867a0)($95930220612465e5$var$languagePicked), "/");
(0, $0338f0fd1d201d30$export$ee302119ce9aa13b)(()=>(0, $0bef1161658a365b$export$1edb4355a6269a50)($95930220612465e5$var$languagePicked));
(0, $0338f0fd1d201d30$export$ee302119ce9aa13b)(()=>(0, $a8557712adc6aeba$export$2d4a6191d4d5b892)($95930220612465e5$var$languagePicked));
